...
<template>
  <section class="dark">
    <div class="hero min-h-screen bg-neutral-100 dark:bg-[#062534] transparent-wave dark:text-white">
      <div class="hero-content flex-col lg:flex-row space-y-7">
        <div class="mx-auto px-7 2xl:px-36">
          <h1 class="md:text-center text-5xl 2xl:text-7xl font-semibold">
            Tutorial Install
            <span
          ...
          <p class="py-6 md:text-center md:mt-4 2xl:text-xl">
            ...
            buat web sederhana bertema Tutorial menginstall tailwind pada
            project anda
          </p>
        </div>
      </div>
