    ...
    <section class="mb-32 text-gray-800 text-center md:text-left">
      ...
      <nav
        ...
        <ol class="list-reset flex">
          ...
          <li>
            <NuxtLink to="/new-project">New Project</NuxtLink>
          </li>
          <li>
            <span class="mx-2 text-neutral-500 dark:text-neutral-300">/</span>
          </li>
          <li class="text-neutral-500 dark:text-neutral-300">{{ route.params.id }}</li>
        </ol>
      </nav>
      <div class="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
        ...
        <div class="mb-6 md:mb-0">
          ...
          <button @click="$router.push(`/new-project`)" type="button" class="inline-block rounded-full bg-neutral-800 mt-6 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-neutral-50 shadow-[0_4px_9px_-4px_rgba(51,45,45,0.7)] transition duration-150 ease-in-out hover:bg-neutral-800 hover:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] focus:bg-neutral-800 focus:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] focus:outline-none focus:ring-0 active:bg-neutral-900 active:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] dark:bg-neutral-900 dark:shadow-[0_4px_9px_-4px_#030202] dark:hover:bg-neutral-900 dark:hover:shadow-[0_8px_9px_-4px_rgba(3,2,2,0.3),0_4px_18px_0_rgba(3,2,2,0.2)] dark:focus:bg-neutral-900 dark:focus:shadow-[0_8px_9px_-4px_rgba(3,2,2,0.3),0_4px_18px_0_rgba(3,2,2,0.2)] dark:active:bg-neutral-900 dark:active:shadow-[0_8px_9px_-4px_rgba(3,2,2,0.3),0_4px_18px_0_rgba(3,2,2,0.2)]">
          Kembali
          </button>
        </div>
      </div>
